...
const hoverTargets = 'a, button, .project-card, .process-card, .map-hotspot, .js-profile-trigger, .luffy-avatar, .q-link';
...
const pmImg = document.querySelector('#pm-img');
...
document.querySelectorAll('.map-hotspot').forEach(hotspot => {
  hotspot.addEventListener('click', () => {
    if (projectModal && pmTitle && pmDesc) {
      ...
      `;
      pmImg.src = document.querySelector('.mastery-map-img').src;
